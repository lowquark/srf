...
namespace draw {
  ...
  void calc_quad(float * vertex_data, const Rect2i rect) {
    if(_window_size.x != 0 && _window_size.y != 0) {
      vertex_data[0] =  2.0f * ((float) (rect.pos.x              ) + PIXEL_FUDGE) / _window_size.x - 1.0f;
      vertex_data[1] = -2.0f * ((float) (rect.pos.y              ) + PIXEL_FUDGE) / _window_size.y + 1.0f;
      vertex_data[2] =  2.0f * ((float) (rect.pos.x + rect.size.x) + PIXEL_FUDGE) / _window_size.x - 1.0f;
      vertex_data[3] = -2.0f * ((float) (rect.pos.y              ) + PIXEL_FUDGE) / _window_size.y + 1.0f;
      vertex_data[4] =  2.0f * ((float) (rect.pos.x + rect.size.x) + PIXEL_FUDGE) / _window_size.x - 1.0f;
      vertex_data[5] = -2.0f * ((float) (rect.pos.y + rect.size.y) + PIXEL_FUDGE) / _window_size.y + 1.0f;
      vertex_data[6] =  2.0f * ((float) (rect.pos.x              ) + PIXEL_FUDGE) / _window_size.x - 1.0f;
      vertex_data[7] = -2.0f * ((float) (rect.pos.y + rect.size.y) + PIXEL_FUDGE) / _window_size.y + 1.0f;
    } else {
      vertex_data[0] = -1.0f;
      vertex_data[1] =  1.0f;
      vertex_data[2] =  1.0f;
